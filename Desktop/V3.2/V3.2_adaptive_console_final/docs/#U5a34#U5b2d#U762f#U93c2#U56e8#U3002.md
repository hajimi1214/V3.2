...
|---|---|
| 平台版本 | V3.2 |
| 生成时间 | 2026-05-19 21:08:22 |
| 启动批次 | ZLTX-RUN-20260519-210822 |
| API 地址 | `http://127.0.0.1:7860` / `http://<平台主机IP>:7860` |
| API 密钥 | `zltx_live_sk_v3_2_tUv_bTUTFhk_R_nfaOIUFSNAP0PtpC286hukHMy3DpKMPJQF3gXntQCKjMODTQ2l` |
| 建议工具 | JMeter、Postman、Apifox、自研测试平台 |

## 2. API 测试密钥

- 请求头名称：`X-Agent-Test-Key`
- 当前运行密钥：`zltx_live_sk_v3_2_tUv_bTUTFhk_R_nfaOIUFSNAP0PtpC286hukHMy3DpKMPJQF3gXntQCKjMODTQ2l`
